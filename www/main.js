...
((app) => {
    ...
    class ResultView extends View {
        constructor(elementId, buttonId, imageId, textId, authorTextId, attributionLinkId) {
            super(elementId);
            this._restartButton = new View(buttonId);
            this._imageView = new View(imageId);
            this._textView = new View(textId);
            this._authorTextView = new View(authorTextId);
            this._attributionLink = new View(attributionLinkId);
        }
    ...
    class InputView extends View {
        constructor(elementId, formId, inputId, buttonId) {
            super(elementId);
            this._input = new View(inputId);
            this._form = new View(formId);
            this._button = new View(buttonId);
        }
    ...
    class App {
        constructor(api) {
            this._api = api;
            this._resultView = new ResultView("result-view", "restart-button", "result-image", "result-text", "result-author", "attribution-link");
            this._inputView = new InputView("input-view", "text-form", "text", "submit");
            this._mainView = new MainView("main-view");
